...
DWMS_sidebar_config = {
    "sidebar_groups": [{
        ...
        "sidebar_group_content": [{
            "id": 0,
            "name": "企业基本信息",
            "url": "<?php echo U('Home/DistrictProduction/production_basic_information');?>"
        }]
    }, {
        "sidebar_group_id": 1,
        "sidebar_group_title": "危险废物台账",
        "sidebar_group_content": [{
            "id": 0,
            "name": "危废产生月报统计",
            "url": "<?php echo U('Home/DistrictProduction/waste_account_monthly_statistics');?>"
        }]
    }, {
        "sidebar_group_id": 2,
        ...
        "sidebar_group_content": [{
            "id": 0,
            "name": "RFID手持端绑定",
            "url": "<?php echo U('Home/DistrictProduction/production_rfid_hand_equipment');?>"
        }]
    }]
}
</script>
