...
DWMS_sidebar_config = {
    "sidebar_groups": [{
        ...
        "sidebar_group_content": [{
            "id": 0,
            "name": "企业基本信息",
            "url": "<?php echo U('Home/ReceptionBasic/reception_basic_information');?>"
        }, {
            "id": 1,
            "name": "基本信息变更",
            "url": "<?php echo U('Home/ReceptionBasic/reception_change_information');?>"
        }, {
            "id": 2,
            "name": "自行处置设备信息",
            "url": "<?php echo U('Home/ReceptionBasic/device_information');?>"
        }, {
            "id": 3,
            "name": "存储场所",
            "url": "<?php echo U('Home/ReceptionBasic/storage_place');?>"
        }]
    }, {
        "sidebar_group_id": 1,
