    ...
    <div class="modal-dialog" style="width:70%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">企业废物接受详细信息</h4>
            </div>
...
function setTable() {
    ...
    for (var idx in reception_unit_json) {
        ...
        itemData[1] = "" + reception_unit_json[idx].reception_unit_address;
        itemData[2] = "" + reception_unit_json[idx].reception_unit_county;
        itemData[3] = "<?php echo ((session('jurisdiction_name'))?(session('jurisdiction_name')):'环保局'); ?>";
        itemData[4] = '<a href="#" onclick="fetch_model_page(\'./waste_reception_account_monthly_statistics_page?reception_unit_id=' + reception_unit_json[idx].reception_unit_id + '\')"><span class="label label-success"><span class="glyphicon glyphicon-wrench"></span> 详情</span><a>';
