...
DWMS_page_config.pageid = 5;
DWMS_sidebar_config = {
    "sidebar_groups": [{
        "sidebar_group_id": 0,
        "sidebar_group_title": "转移备案管理",
        "sidebar_group_content": [{
            "id": 0,
            "name": "转移备案",
            "url": "<?php echo U('Home/DistrictTransfer/transfer_record');?>"
        }]
    }, {
        "sidebar_group_id": 1,
        "sidebar_group_title": "危废联单管理",
        "sidebar_group_content": [{
            "id": 0,
            "name": "生产单位转移联单",
            "url": "<?php echo U('Home/DistrictTransfer/production_transfer_manifest');?>"
        }, {
            "id": 1,
            "name": "运输单位转移联单",
            "url": "<?php echo U('Home/DistrictTransfer/transport_transfer_manifest');?>"
        }, {
            "id": 2,
            "name": "接受单位转移联单",
            "url": "<?php echo U('Home/DistrictTransfer/reception_transfer_manifest');?>"
        }]
    }, {
        "sidebar_group_id": 2,
        "sidebar_group_title": "统计分析",
        "sidebar_group_content": [{
            "id": 0,
            "name": "转移去向统计",
            "url": "<?php echo U('Home/DistrictTransfer/transfer_direction_statistic');?>"
        },{
            "id": 1,
            "name": "转移联单统计",
            "url": "<?php echo U('Home/DistrictTransfer/transfer_manifest_statistic');?>"
        },{
            "id": 2,
            "name": "转移专题定制",
            "url": "<?php echo U('Home/DistrictTransfer/transfer_topic_customize');?>"
        }]
    }]
}
</script>
