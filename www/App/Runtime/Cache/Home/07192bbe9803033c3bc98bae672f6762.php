            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr>
                        ...
                        <td>备案类型</td>
                        <td>
                            <input type="text" name="record_type" class="form-control input-sm required-cn" placeholder="备案类型">
                        </td>
                    </tr>
                    <tr>
                        <td>法人代码</td>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr>
                        <td>危废代码</td>
                        <td>
                            <select id="waste_code" type="text" class="form-control input-sm" placeholder="危废代码">      
                        </td>
                        <td>相关产品</td>
                        <td>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tr>
                        <td>主要废物名称</td>
                        <td>
                            <input type="text" name="waste_name" class="form-control input-sm" placeholder="废物名称">
                        </td>
                    </tr>
                    <tr>
                        <td>主要废物形态</td>
                        <td>
                            <select type="text" name="waste_form" class="form-control input-sm" placeholder="废物形态">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tr>
                        ...
                        <td>贮存面积（平方米）</td>
                        <td>
                            <input type="text" name="storage_area" class="form-control input-sm number-cn" placeholder="贮存面积（平方米）">
                        </td>
                    </tr>
                    <tr>
                        <td>危废容积（立方米）</td>
                        <td>
                            <input type="text" name="waste_volume" class="form-control input-sm number-cn" placeholder="危废容积（立方米）">
                        </td>
                        <td>贮存用途</td>
                        <td>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tr>
                        <td>运输单位名称</td>
                        <td>
                            <select type="text" id="transport_unit_id" name="transport_unit_id" class="form-control input-sm required-cn" onchange="transport_select(this.options[this.options.selectedIndex].value)">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-condensed">
                      <tr>
                        <td>接受单位名称</td>
                        <td>
                            <select type="text" id="reception_unit_id" name="reception_unit_id" class="form-control input-sm required-cn" onchange="reception_select(this.options[this.options.selectedIndex].value)">
...
<div id="myAlert"></div>
<center>
    <button class="btn btn-info btn-lg" id="button_save" onclick="ajaxAction(0)">保存</button>
    <button class="btn btn-warning btn-lg" id="button_submit" onclick="ajaxAction(1)">提交</button>
</center>
<script type="text/javascript" src="__PUBLIC__/js/jquery-validate.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/js/jquery-myvalidate.js"></script>
<script>
$("#record_request_1").validate();
$("#record_request").validate();
...
var weight = 0.0;
var num = 0.0; 
var t_length=transport_unit.length;
var r_length=reception_unit.length;
$('#waste_code').html('<option>请选择主要危废代码</option>')
for (var idx in waste) {
    $('#waste_code').append('<option value="' + waste[idx].waste_code + '">'+ waste[idx].waste_code + '</option>');
}

// $('#transport_unit_id').html('<option>请选择运输单位</option>');
$('#transport_unit_county').html(transport_unit[0].transport_unit_county);
    $('#transport_unit_address').html(transport_unit[0].transport_unit_address);
    $('#transport_unit_postcode').html(transport_unit[0].transport_unit_postcode);
    $('#transport_unit_contacts_name').html(transport_unit[0].transport_unit_contacts_name);
    $('#transport_unit_contacts_phone').html(transport_unit[0].transport_unit_contacts_phone);

$('#reception_unit_county').html(reception_unit[0].reception_unit_county);
    $('#reception_unit_address').html(reception_unit[0].reception_unit_address);
    $('#reception_unit_postcode').html(reception_unit[0].reception_unit_postcode);
    $('#reception_unit_contacts_name').html(reception_unit[0].reception_unit_contacts_name);
    $('#reception_unit_contacts_phone').html(reception_unit[0].reception_unit_contacts_phone);
...
function ajaxAction(actionID) {
    ...
    $.ajax({
        ...
        timeout: 2000,
        data: $('#record_request').serialize() + '&' + $('#record_request_1').serialize() + '&record_status=' + actionID + '&rfid_table_id=' + rfid_table_id + '&predict_output_quantity=' + num + '&predict_output_weight=' + weight,
