    ...
    <div class="modal-dialog" style="width:70%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">运输单位联单</h4>
            </div>
...
function setTable() {
    ...
    for (var idx in manifest_json) {
        var itemDetail = '<a href="#" onclick="fetch_model_page(\'./transfer_manifest_query_page?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-paperclip"></span> 详情</span><a>';
