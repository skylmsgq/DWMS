...
DWMS_page_config.pageid = 4;
DWMS_sidebar_config = {
    "sidebar_groups": [{
        "sidebar_group_id": 0,
        "sidebar_group_title": "转移联单",
        "sidebar_group_content": [{
            "id": 0,
            "name": "转移联单处理",
            "url": "<?php echo U('Home/TransportManifest/transfer_manifest_handle');?>"
        }, {
            "id": 1,
            "name": "转移联单查询",
            "url": "<?php echo U('Home/TransportManifest/transfer_manifest_query');?>"
        }]
    }, {
        "sidebar_group_id": 1,
