...
DWMS_page_config = {
    "menu": [{
        "id": 0,
        "name": "首页",
        "url": "<?php echo U('Home/LoginTransport/homepage');?>"
    }, {
        "id": 1,
        "name": "企业基本信息",
        "url": "<?php echo U('Home/TransportBasic/basic_sidebar');?>"
    }, {
        "id": 2,
        "name": "运输车辆",
        "url": "<?php echo U('Home/TransportVehicle/vehicle_sidebar');?>"
    }, {
        "id": 3,
        "name": "转移联单",
        "url": "<?php echo U('Home/TransportManifest/manifest_sidebar');?>"
    }],
}
</script>

<script type="text/javascript">
DWMS_page_config.pageid = 2;
DWMS_sidebar_config = {
    "sidebar_groups": [{
        "sidebar_group_id": 0,
        "sidebar_group_title": "运输车辆",
        "sidebar_group_content": [{
            "id": 0,
            "name": "运输车辆管理",
            "url": "<?php echo U('Home/TransportVehicle/vehicle_management');?>"
        }, {
            "id": 1,
            "name": "运输车辆添加",
            "url": "<?php echo U('Home/TransportVehicle/vehicle_add');?>"
        }, {
            "id": 2,
            "name": "GPS 绑定",
            "url": "<?php echo U('Home/TransportVehicle/vehicle_gps_binding');?>"
        }]
    }, {
        "sidebar_group_id": 1,
