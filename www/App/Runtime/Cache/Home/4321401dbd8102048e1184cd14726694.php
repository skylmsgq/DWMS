...
DWMS_sidebar_config = {
    "sidebar_groups": [{
        ...
        "sidebar_group_content": [{
            "id": 0,
            "name": "企业基本信息",
            "url": "<?php echo U('Home/DistrictReception/reception_basic_information');?>"
        }]
    }, {
        "sidebar_group_id": 1,
        "sidebar_group_title": "危废接受台账",
        "sidebar_group_content": [{
            "id": 0,
            "name": "危废接受月报统计",
            "url": "<?php echo U('Home/DistrictReception/waste_reception_account_monthly_statistics');?>"
        }]
    }, {
        "sidebar_group_id": 2,
        "sidebar_group_title": "RFID手持端",
        "sidebar_group_content": [{
            "id": 0,
            "name": "RFID手持端绑定",
            "url": "<?php echo U('Home/DistrictReception/reception_rfid_hand_equipment');?>"
        }]
    }]
}
</script>
