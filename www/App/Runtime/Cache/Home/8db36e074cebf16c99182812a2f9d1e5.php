...
function setTable() {
    ...
    for (var idx in production_unit_json) {
        ...
        itemData[4] = '<a href="#" onclick="fetch_model_page(\'./production_basic_information_page?record_id=' + production_unit_json[idx].production_unit_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-wrench"></span> 详情</span><a>';
