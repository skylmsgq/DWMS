...
function setTable() {
    ...
    for (var idx in record_json) {
        ...
        itemData[6] = '<a href="#" onclick="fetch_model_page(\'./storage_input_management_page?record_id=' + record_json[idx].rfid_id + '&waste_code=' + waste_json[idx] + '\')"><span class="label label-info"><span class="glyphicon glyphicon-wrench"></span> 详情</span><a>';
