    ...
    <div class="modal-dialog" style="width:70%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">GPS 绑定</h4>
            </div>
...
function setTable() {
    ...
    for (var idx in vehicle) {
        var itemBinding = '<a href="#" onclick="fetch_model_page(\'./vehicle_gps_binding_request?vehicle_id=' + vehicle[idx].vehicle_id + '\')"><span class="label label-success"><span class="glyphicon glyphicon-paperclip"></span> GPS 绑定</span><a>';
        var itemData = new Array();
        itemData[0] = "" + vehicle[idx].vehicle_id;
        itemData[1] = "" + transport_unit_name;
        itemData[2] = "" + vehicle[idx].vehicle_num;
        itemData[3] = "" + vehicle[idx].vehicle_type;
        itemData[4] = "" + itemBinding;
