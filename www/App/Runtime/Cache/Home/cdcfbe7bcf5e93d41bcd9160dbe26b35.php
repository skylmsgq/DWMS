...
DWMS_sidebar_config = {
    "sidebar_groups": [{
        "sidebar_group_id": 0,
        "sidebar_group_title": "系统信息",
        "sidebar_group_content": [{
            "id": 0,
            "name": "废物代码",
            "url": "<?php echo U('Home/DistrictSystem/waste_code');?>"
        }, {
            "id": 1,
            "name": "区县代码",
            "url": "<?php echo U('Home/DistrictSystem/district_code');?>"
        }, {
            "id": 2,
            "name": "行业代码",
            "url": "<?php echo U('Home/DistrictSystem/trade_code');?>"
        }, {
            "id": 3,
            "name": "企业规模",
            "url": "<?php echo U('Home/DistrictSystem/enterprise_scale');?>"
        }, {
            "id": 4,
            "name": "注册类型",
            "url": "<?php echo U('Home/DistrictSystem/register_type');?>"
        }, {
            "id": 5,
            "name": "管辖权限",
            "url": "<?php echo U('Home/DistrictSystem/jurisdiction');?>"
        }, {
            "id": 6,
            "name": "废物类别",
            "url": "<?php echo U('Home/DistrictSystem/waste_category');?>"
        }, {
            "id": 7,
            "name": "废物形态",
            "url": "<?php echo U('Home/DistrictSystem/waste_form');?>"
        }, {
            "id": 8,
            "name": "包装方式",
            "url": "<?php echo U('Home/DistrictSystem/package_method');?>"
        }, {
            "id": 9,
            "name": "废物处理方式",
            "url": "<?php echo U('Home/DistrictSystem/waste_disposal_method');?>"
        }, {
            "id": 10,
            "name": "废物去向",
            "url": "<?php echo U('Home/DistrictSystem/waste_direction');?>"
        }, {
            "id": 11,
            "name": "运输方式",
            "url": "<?php echo U('Home/DistrictSystem/transport_method');?>"
        }]
    }, {
        "sidebar_group_id": 1,
        "sidebar_group_title": "设备管理",
        "sidebar_group_content": [{
            "id": 0,
            "name": "添加设备",
            "url": "<?php echo U('Home/DistrictSystem/device_add');?>"
        }, {
            "id": 1,
            "name": "管理设备",
            "url": "<?php echo U('Home/DistrictSystem/device_management');?>"
        }]
    }]
}
</script>
