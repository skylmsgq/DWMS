...
function setTable() {
    ...
    for (var idx in manifest_json) {
        ...
        switch (manifest_json[idx].manifest_status) {
            case '4':
                itemData[3] = "<span class='label label-danger'>未填写</span>";
            ...
            case '9':
                ...
                break;
            case '10':
                itemData[3] = "<span class='label label-info'>已提交待审核</span>";
                itemData[4] = "";
                break;
            case '11':
                ...
                break;
            case '12':
                itemData[3] = "<span class='label label-warning'>未通过待修改</span>";
