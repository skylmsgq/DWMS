...
function setTable() {
    ...
    for (var idx in reception_unit_json) {
        ...
        itemData[4] = '<a href="#" onclick="fetch_model_page(\'./reception_basic_information_page?record_id=' + reception_unit_json[idx].reception_unit_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-wrench"></span> 详情</span><a>';
