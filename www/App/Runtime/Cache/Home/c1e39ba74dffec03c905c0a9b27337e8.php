        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tr>
                    <td>工艺序号</td>
                    <td>
                        <?php echo ($record["technology_code"]); ?>
                    </td>
                    <td>工艺方法</td>
                    <td>
                        <?php echo ($record["technology_method"]); ?>
                    </td>
                </tr>
                <tr>
                    <td>危废代码</td>
                    <td>
                        <?php echo ($record["waste_code"]); ?>
                    </td>
                    <td>相关产品</td>
                    <td>
                        <?php echo ($record["relational_production"]); ?>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tr>
                    <td>废物名称</td>
                    <td>
                        <?php echo ($record["waste_name"]); ?>
                    </td>
                    <td>废物形态</td>
                    <td>
                        <?php echo ($record["waste_form"]); ?>
                    </td>
                </tr>
                <tr>
                    <td>预计危废重量（吨）</td>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tr>
                    <td>贮存场所</td>
                    <td>
                        <?php echo ($record["storage_place"]); ?>
                    </td>
                    <td>贮存面积（平方米）</td>
                    <td>
                        <?php echo ($record["storage_area"]); ?>
                    </td>
                </tr>
                <tr>
                    <td>危废容积（立方米）</td>
                    <td>
                        <?php echo ($record["waste_volume"]); ?>
                    </td>
                    <td>贮存用途</td>
                    <td>
                        <?php echo ($record["storage_purpose"]); ?>
                    </td>
                </tr>
            </table>
        </div>
...
if (record_status_json == '1') {
    $('#button_close').before("<button class='btn btn-success btn-lg' id='button_pass' onclick='ajaxAction(2)'>通过备案</button>&nbsp;<button class='btn btn-danger btn-lg' id='button_reject' onclick='ajaxAction(3)'>退回备案</button>&nbsp;");
}
...
function ajaxAction(actionID) {
    ...
    $.ajax({
        type: "post",
        url: "transfer_record_management_audit?record_id=" + record_id_json,
        timeout: 2000,
        data: {
