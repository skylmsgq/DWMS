...
function setTable() {
    ...
    for (var idx in manifest_json) {
        ...
        var itemModify = ' <a href="#" onclick="fetch_model_page(\'./transfer_manifest_handle_modify?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-danger"><span class="glyphicon glyphicon-paperclip"></span> 修改</span><a>';
        var itemSubmit = ' <a href="#" onclick="fetch_model_page(\'./transfer_manifest_handle_submit?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-success"><span class="glyphicon glyphicon-paperclip"></span> 提交</span><a>';
        ...
        switch (manifest_json[idx].manifest_status) {
            case '1':
                itemData[3] = "<span class='label label-info'>未填写</span>";
                itemData[4] = "" + itemRequest;
                break;
            case '2':
                itemData[3] = "<span class='label label-primary'>已填写未提交</span>";
