...
function setTable() {
    ...
    for (var idx in record_json) {
        ...
        itemData[2] = "" + record_json[idx].production_unit_name;
        ...
        itemData[4] = '<a href="#" onclick="fetch_model_page(\'./transfer_record_management_page?record_id=' + record_json[idx].record_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-wrench"></span> 操作</span><a>';
