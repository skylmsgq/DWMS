...
DWMS_sidebar_config = {
    "sidebar_groups": [{
        ...
        "sidebar_group_content": [{
            "id": 0,
            "name": "企业基本信息",
            "url": "<?php echo U('Home/DistrictTransport/transport_basic_information');?>"
        }]
    }, {
        "sidebar_group_id": 1,
        "sidebar_group_title": "运输车辆管理",
        "sidebar_group_content": [{
            "id": 0,
            "name": "运输车辆管理",
            "url": "<?php echo U('Home/DistrictTransport/transport_vehicle_management');?>"
        }]
    }, {
        "sidebar_group_id": 2,
