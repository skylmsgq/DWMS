    ...
    <div class="modal-dialog" style="width:70%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">区县代码修改</h4>
            </div>
...
function setTable() {
    ...
    for (var idx in record_json) {
        var itemDelete = '<a href="#" onclick="record_delete(\'./county_code_delete?record_id=' + record_json[idx].county_id + '\')"><span class="label label-danger"><span class="glyphicon glyphicon-paperclip"></span> 删除</span><a>';
        var itemModify = ' <a href="#" onclick="fetch_model_page(\'./county_code_modify?record_id=' + record_json[idx].county_id + '\')"><span class="label label-primary"><span class="glyphicon glyphicon-paperclip"></span> 修改</span><a>';
        var itemData = new Array();
        itemData[0] = "" + record_json[idx].county_code;
        itemData[1] = "" + record_json[idx].county_name;
