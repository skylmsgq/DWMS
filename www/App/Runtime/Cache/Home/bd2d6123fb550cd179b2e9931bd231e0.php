...
function setTable() {
    ...
    for (var idx in manifest_json) {
        var itemDetail = '<a href="#" onclick="fetch_model_page(\'./transfer_manifest_query_detail?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-paperclip"></span> 详情</span><a>';
        var itemModify = ' <a href="#" onclick="fetch_model_page(\'./transfer_manifest_query_modify?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-warning"><span class="glyphicon glyphicon-paperclip"></span> 修改</span><a>';
        var itemSubmit = ' <a href="#" onclick="fetch_model_page(\'./transfer_manifest_query_submit?manifest_id=' + manifest_json[idx].manifest_id + '\')"><span class="label label-primary"><span class="glyphicon glyphicon-paperclip"></span> 提交</span><a>';
        ...
        switch (manifest_json[idx].manifest_status) {
            ...
            case '7':
                ...
                break;
            case '8':
                itemData[3] = "<span class='label label-info'>已修改未提交</span>";
                itemData[4] += itemModify + itemSubmit;
                break;
            case '9':
                itemData[3] = "<span class='label label-warning'>已提交待审核</span>";
            ...
            case '10':
                ...
                break;
            case '11':
                itemData[3] = "<span class='label label-success'>已通过</span>";
                break;
            case '12':
                itemData[3] = "<span class='label label-warning'>已提交待审核</span>";
                break;
