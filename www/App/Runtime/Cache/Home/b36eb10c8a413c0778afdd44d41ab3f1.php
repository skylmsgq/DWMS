...
function setTable() {
    ...
    for (var idx in record_json) {
        ...
        itemData[4] = '<a href="#" onclick="fetch_model_page(\'./transfer_record_page?record_id=' + record_json[idx].record_id + '\')"><span class="label label-info"><span class="glyphicon glyphicon-wrench"></span> 查看</span><a>';
