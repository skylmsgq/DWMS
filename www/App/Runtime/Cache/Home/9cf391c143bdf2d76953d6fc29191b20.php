        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                <tr>
                    <td>运输单位</td>
                    <td>
                        <?php echo ($record["transport_unit_id"]); ?>
                    </td>
                    <td>接受单位</td>
                    <td>
                        <?php echo ($record["reception_unit_id"]); ?>
                    </td>
                </tr>                 
                <tr>
                    <td>危废编号</td>
                    <td>
                        <?php echo ($record["waste_id"]); ?>
                    </td>
                    <td>危废重量</td>
                    <td>
                ...
                <tr>
                    <td>危废包装方式</td>
                    <td>
                        <input type="text" name="waste_package" class="form-control input-sm" placeholder="危废包装方式">
                    </td>
                    <td>危废外运目的</td>
                    <td>
                        <input type="text" name="waste_transport_goal" class="form-control input-sm" placeholder="危废外运目的">
                    </td>
                </tr>
                <tr>
                    <td>应急措施</td>
                    ...
                    <td>危废发运人</td>
                    <td>
                        <input type="text" name="waste_shipper" class="form-control input-sm" placeholder="危废发运人">
                    </td>
                </tr>
                <tr>
                    <td>危废运达地</td>
                    <td>
                        <input type="text" name="waste_destination" class="form-control input-sm" placeholder="危废运达地">
                        <!-- <?php echo ($reception_unit["reception_unit_address"]); ?> -->
                    </td>
                    <td>危废转移时间</td>
                    <td>
                        <input type="date" name="waste_transport_time" class="form-control input-sm" placeholder="危废转移时间">
                    </td>
                </tr>
            </table>
        </div>
...
function ajaxAction(actionID,transport_unit_name) {
    ...
    $.ajax({
        ...
        data: $('#manifest_request').serialize() + '&manifest_status=' + actionID  + '&transport_unit_id=' + record_json.transport_unit_id + '&reception_unit_id=' + record_json.reception_unit_id + '&waste_id=' + record_json.waste_id + '&waste_weight=' + record_json.predict_output_weight,
