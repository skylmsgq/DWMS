        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                <tr>
                    <td>单位名称</td>
                    <td>
                        <?php echo ($reception_unit["reception_unit_name"]); ?>
                    </td>
                    <td>单位用户名称</td>
                    <td>
                        <?php echo ($reception_unit["reception_unit_username"]); ?>
                    </td>
                </tr>
                <tr>
                    <td>法人代码</td>
                    <td>
                        <?php echo ($reception_unit["reception_unit_legal_person_code"]); ?>
                    </td>
                    <td>单位地址</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>所在区县</td>
                    <td>
                        <?php echo ($reception_unit["waste_location_county"]); ?>
                    </td>
                </tr>
                <tr>
                    <td>联系人姓名</td>
                ...
                <tr>
                    <td>单位传真</td>
                    <td>
                        <?php echo ($reception_unit["reception_unit_fax"]); ?>
                    </td>
                    <td>产废设施所在地</td>
                    <td>
                        <?php echo ($reception_unit["waste_location"]); ?>
                    </td>
                </tr> 
            </table>
            </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                <tr>
                    <td>接受单位经营许可证号</td>
                    <td>
                        <input type="text" name="reception_unit_license_num" class="form-control input-sm" placeholder="<?php echo ($manifest["reception_unit_license_num"]); ?>" value="<?php echo ($manifest["reception_unit_license_num"]); ?>">  
                    </td>
                    <td>接收人姓名</td>
                    <td>
                        <input type="text" name="receiver_name" class="form-control input-sm" placeholder="<?php echo ($manifest["receiver_name"]); ?>" value="<?php echo ($manifest["receiver_name"]); ?>">  
                    </td>
                </tr>
                <tr>
                    <td>接收人工号</td>
                    <td>
                        <input type="text" name="receiver_num" class="form-control input-sm" placeholder="<?php echo ($manifest["receiver_num"]); ?>" value="<?php echo ($manifest["receiver_num"]); ?>">  
                    </td>
                    <td>接收日期</td>
                    <td>
                        <input type="text" name="receive_date" class="form-control input-sm" placeholder="<?php echo ($manifest["receive_date"]); ?>" value="<?php echo ($manifest["receive_date"]); ?>">  
                    </td>
                </tr>
                <tr>
                    <td>废物处置方式</td>
                    <td>
                        <input type="text" name="waste_disposal_method" class="form-control input-sm" placeholder="<?php echo ($manifest["waste_disposal_method"]); ?>" value="<?php echo ($manifest["waste_disposal_method"]); ?>">  
                    </td>
                    <td>接受单位负责人姓名</td>
                    <td>
                        <input type="text" name="reception_unit_principal_name" class="form-control input-sm" placeholder="<?php echo ($manifest["reception_unit_principal_name"]); ?>" value="<?php echo ($manifest["reception_unit_principal_name"]); ?>">  
                    </td>
                </tr>
                <tr>
                    <td>接受单位负责人审核日期</td>
                    <td>
                        <input type="text" name="reception_unit_audit_date" class="form-control input-sm" placeholder="<?php echo ($manifest["reception_unit_audit_date"]); ?>" value="<?php echo ($manifest["reception_unit_audit_date"]); ?>">  
                    </td>
                    <td></td>
                    <td>
                    </td>
