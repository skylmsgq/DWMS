...
<head>
    ...
    function sel_city(province_id){
        console.log(province_id);
          $.ajax({
            type: "post",
            url: "/index.php/Home/Register/select_city_name.html",
            dataType: "json",
            data:{
                'id': province_id
            },
     ...
     function sel_county(city_id){
        console.log(city_id);
          $.ajax({
            type: "post",
            url: "/index.php/Home/Register/select_county_name.html",
            dataType: "json",
            data:{
                'id': city_id
            },
    ...
    function county_code_jurisdiction(county_name){
        ...
        $.ajax({
            type: "post",
            url: "/index.php/Home/Register/select_code_jurisdiction.html",
            dataType: "json",
            data:{
                'name': county_name
            },
    ...
    $.ajax({
            type: "post",
            url: "/index.php/Home/Register/select_code.html",
            dataType: "json",
            data:{
                'name': county_name
            },
            success: function(code_json) {
                ...
                $('#waste_location_county_code').html('<option>区县代码</option>');
                for (var idx in county_name) {
                $('#waste_location_county_code').append('<option value="' + code[idx].county_code + '">' + code[idx].county_code + '</option>');
                }   
...
<body style="background:url(/Public/image/bg_3.jpg) no-repeat;  background-color:#3D80AD;">
    <div class="container">
        <div class="panel panel-primary" id="login-panel" style="margin-top:20px">
            ...
            <div class="panel-body" style="">
                ...
                <form role="form" method="post" id="productionForm" action="/index.php/Home/Register/do_reg/id/production.html">
...
<!--                                    <input type="text" class="form-control input-md required-cn" name="waste_location_county_code" id="waste_location_county_code">
 -->                   
                ...
                <script type="text/javascript" src="/Public/js/jquery-myvalidate.js"></script>
                <script>
