    ...
    function county_code_jurisdiction(county_name){
        ...
        $.ajax({
            ...
            success: function(jurisdiction_json) {
                ...
                $('#jurisdiction_id').append('<option value="' + jurisdiction[idx].jurisdiction_name + '">' + jurisdiction[idx].jurisdiction_name + '</option>');
                }
                               ...
                               <!--     <input type="text" class="form-control input-md required-cn" name="waste_location_county_code" id="waste_location_county_code"> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <option>采掘业</option>
                                        <option>煤炭采选业</option>
                                        <option>石油和天然气开采业</option>
                                        <option>黑色金属矿采选业</option>
                                        <option>有色金属矿采选业</option>
                                        <option>非金属矿采选业</option>
                                        <option>采盐业</option>
                                        <option>其他矿采选业</option>
                                        <option>木材及竹材采运业</option>
                                        <option>制造业</option>
                                        <option>食品加工业</option>
                                        <option>食品制造业</option>
                                        <option>饮料制造业</option>
                                        <option>烟草加工业</option>
                                        <option>纺织业</option>
                                        <option>服装及其他纤维制品制造业</option>
                                        <option>皮革、毛皮、羽绒及其制品业</option>
                                        <option>木材加工及竹、藤、棕、草制品业</option>
                                        <option>家具制造业</option>
                                        <option>造纸及纸制品业</option>
                                        <option>印刷业，记录媒介的复制</option>
                                        <option>文教体育用品制造业</option>
                                        <option>石油加工及炼焦业</option>
                                        <option>化学原料及化学制品制造业</option>
                                        <option>医药制造业</option>
                                        <option>生物制品业</option>
                                        <option>化学纤维制造业</option>
                                        <option>橡胶制品业</option>
                                        <option>塑料制品业</option>
                                        <option>非金属矿物制品业</option>
                                        <option>黑色金属冶炼及压延加工业</option>
                                        <option>有色金属冶炼及压延加工业</option>
                                        <option>金属制品业</option>
                                        <option>日用金属制品业</option>
                                        <option>普通机械制造业</option>
                                        <option>锅炉及原动机制造业</option>
                                        <option>金属加工机械制造业</option>
                                        <option>通用设备制造业</option>
                                        <option>冶金、矿山、机电工业专用设备制造业</option>
                                        <option>石化及其他工业专用设备制造业</option>
                                        <option>轻纺工业专用设备制造业</option>
                                        <option>农、林、牧、渔、水利业机械制造业</option>
                                        <option>医疗器械制造业</option>
                                        <option>其他专用设备制造业</option>
                                        <option>专用机械设备修理业</option>
                                        <option>铁路运输设备制造业</option>
                                        <option>汽车制造业</option>
                                        <option>摩托车制造业</option>
                                        <option>自行车制造业</option>
                                        <option>电车制造业</option>
                                        <option>船舶制造业</option>
                                        <option>航空航天器制造业</option>
                                        <option>交通运输设备修理业</option>
                                        <option>其他交通运输设备制造业</option>
                                        <option>武器弹药制造业</option>
                                        <option>电气机械及器材制造业</option>
                                        <option>电子及通信设备制造业</option>
                                        <option>通信设备制造业</option>
                                        <option>电子计算机制造业</option>
                                        <option>日用电子器具制造业</option>
                                        <option>仪器仪表及文化、办公用机械制造业</option>
                                        <option>其他制造业</option>
                                        <option>电力、煤气及水的生产和供应业</option>
                                        <option>电力、蒸汽、热水的生产和供应业</option>
                                        <option>煤气生产和供应业</option>
                                        <option>自来水的生产和供应业</option>
                                        <option>建筑业</option>
                                        <option>土木工程建筑业</option>
                                        <option>线路、管道和设备安装业</option>
                                        <option>装修装饰业</option>
                                        <option>地质勘查业、水利管理业</option>
                                        <option>地质勘查业</option>
                                        <option>水利管理业</option>
                                        <option>交通运输、仓储及邮电通信业</option>
                                        <option>铁路运输业</option>
                                        <option>公路运输业</option>
                                        <option>管道运输业</option>
                                        <option>水上运输业</option>
                                        <option>航空运输业</option>
                                        <option>交通运输辅助业</option>
                                        <option>其他交通运输业</option>
                                        <option>仓储业</option>
                                        <option>邮电通信业</option>
                                        <option>批发和零售贸易、餐饮业</option>
                                        <option>食品、饮料、烟草和家庭日用品批发业</option>
                                        <option>能源、材料和机械电子设备批发业</option>
                                        <option>其他批发业</option>
                                        <option>零售业</option>
                                        <option>商业经纪与代理业</option>
                                        <option>餐饮业</option>
                                        <option>金融、保险业</option>
                                        <option>金融业</option>
                                        <option>保险业</option>
                                        <option>房地产业</option>
                                        <option>房地产开发与经营业</option>
                                        <option>房地产管理业</option>
                                        <option>房地产经纪与代理业</option>
                                        <option>社会服务业</option>
                                        <option>公共设施服务业</option>
                                        <option>居民服务业</option>
                                        <option>旅馆业</option>
                                        <option>租赁服务业</option>
                                        <option>旅游业</option>
                                        <option>娱乐服务业</option>
                                        <option>信息、咨询服务业</option>
                                        <option>计算机应用服务业</option>
                                        <option>其他社会服务业</option>
                                        <option>卫生、体育和社会福利业</option>
                                        <option>卫生</option>
                                        <option>体育</option>
                                        <option>社会福利保障业</option>
                                        <option>教育、文化艺术及广播电影电视业</option>
                                        <option>教育</option>
                                        <option>文化艺术业</option>
                                        <option>广播电影电视业</option>
                                        <option>科学研究和综合技术服务业</option>
                                        <option>科学研究业</option>
                                        <option>气象</option>
                                        <option>地震</option>
                                        <option>测绘</option>
                                        ...
                                        <option>海洋环境</option>
                                        <option>环境保护</option>
                                        <option>技术推广和科技交流服务业</option>
                                        <option>工程设计业</option>
                                        <option>其他综合技术服务业</option>
                                        <option>国家机关、政党机关和社会团体</option>
                                        <option>国家机关</option>
                                        <option>政党机关</option>
                                        <option>社会团体</option>
                                        <option>基层群众自治组织</option>
                                        <option>其他行业</option>
                                        <option>其他行业</option>
                                        <option></option>
