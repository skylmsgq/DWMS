<?php if (!defined('THINK_PATH')) exit();?><form role="form" id="record_submit">
...
function ajaxAction() {
    ...
    $.ajax({
        type: "post",
        url: "transfer_record_query_submited?record_id=" + record_id_json,
        timeout: 2000,
        data: {
            record_status_old: record_status_json
        },
