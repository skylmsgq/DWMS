 ...
 *
 */
class CityMapAction extends CityCommonAction{
	// -------- 转移地图 侧边栏 --------
	...
	public function designate_vehicle_playback() {
		...
		if ( $transport_unit && $alarm_distance ) {
			...
			$alarm_distance_json = json_encode( $alarm_distance );
			$tmp_content = $this->fetch( './Public/html/Content/City/map/designate_vehicle_playback.html' );
	...
	public function transfer_map_playback() {
		...
		if ( $alarm_distance ) {
			$alarm_distance_json = json_encode( $alarm_distance );
			$tmp_content = $this->fetch( './Public/html/Content/City/map/transfer_map_playback.html' );
	...
	public function gps_data_simulator() {
		...
		if ( $device ) {
			...
			$tmp_content = $this->fetch( './Public/html/Content/City/map/gps_data_simulator.html' );
