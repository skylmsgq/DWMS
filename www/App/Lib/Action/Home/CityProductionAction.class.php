 ...
 *
 */
class CityProductionAction extends CityCommonAction{
	// -------- 危废产生单位->侧边栏 --------
	...
	public function waste_account_monthly_statistics_page($production_unit_id=""){
		...
		$tmp_content = $this->fetch( './Public/html/Content/City/production/waste_account_monthly_statistics_page.html' );
