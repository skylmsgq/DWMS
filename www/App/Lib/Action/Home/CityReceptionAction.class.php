 ...
 *
 */
class CityReceptionAction extends CityCommonAction{
	// -------- 危废处置单位->侧边栏 --------
	public function reception_sidebar(){
		layout( './Common/frame' );
		$this->display( './Public/html/Content/City/reception/reception_sidebar.html' );
	}
	...
	public function reception_basic_information_2(){
        ...
        $tmp_content = $this->fetch('./Public/html/Content/City/reception/reception_basic_information.html');
	...
	public function reception_basic_information_page($record_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/reception/reception_basic_information_page.html' );
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function waste_account_monthly_statistics_2(){
        ...
        $reception_unit_json = json_encode($reception_unit);
        $tmp_content = $this->fetch( './Public/html/Content/City/reception/waste_reception_account_monthly_statistics.html' );
        $tmp_content = "<script>reception_unit_json = $reception_unit_json;</script> $tmp_content";
        $this->ajaxReturn( $tmp_content );
    }
	...
	public function waste_reception_account_monthly_statistics_page($reception_unit_id=""){
		...
		$tmp_content = $this->fetch( './Public/html/Content/City/reception/waste_reception_ccount_monthly_statistics_page.html' );
	...
	public function reception_rfid_hand_equipment(){
		$tmp_content=$this->fetch( './Public/html/Content/City/reception/reception_rfid_hand_equipment.html' );
		$this->ajaxReturn( $tmp_content );
	}
