...
class ProductionManifestAction extends ProductionCommonAction{
	...
	public function transfer_manifest_query_modify($manifest_id="") {
		...
		$tmp_content = "<script>manifest_id_json = $manifest_id_json; manifest_status_json = $manifest_status_json;package_method = $package_method_json;waste_transport_goal = $waste_transport_goal_json;  </script> $tmp_content";
		$this->ajaxReturn( $tmp_content );
	}
