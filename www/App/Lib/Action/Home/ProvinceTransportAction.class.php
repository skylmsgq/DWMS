 ...
 *
 */
class ProvinceTransportAction extends ProvinceCommonAction{
	// -------- 危废运输单位->侧边栏 --------
	public function transport_sidebar(){
		layout( './Common/frame' );
		$this->display( './Public/html/Content/Province/transport/transport_sidebar.html' );
	}
	...
	public function transport_basic_information_2(){
        ...
        $tmp_content = $this->fetch('./Public/html/Content/Province/transport/transport_basic_information.html');
	...
	public function transport_basic_information_page($record_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transport/transport_basic_information_page.html' );
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function transport_vehicle_management_2(){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transport/transport_vehicle_management.html' );
	...
	public function transport_vehicle_management_gps_detail($vehicle_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transport/transport_vehicle_management_gps_detail.html' );
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function transport_vehicle_management_detail($vehicle_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transport/transport_vehicle_management_detail.html' );
		$this->ajaxReturn( $tmp_content );
	}

	// 危废运输单位->GPS监控信息->GPS监控信息
	public function transport_gps_monitor_information(){
		$tmp_content=$this->fetch( './Public/html/Content/Province/transport/transport_gps_monitor_information.html' );
		$this->ajaxReturn( $tmp_content );
	}
