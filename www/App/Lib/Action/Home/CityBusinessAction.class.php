...
class CityBusinessAction extends CityCommonAction{
	...
	public function transfer_manifest_management_page($manifest_id="") {
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/business/transfer_manifest_management_page.html' );
	...
	// 业务办理->待办业务->联单编号绑定
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/business/manifest_serial_num_binding.html' );
	...
	public function manifest_serial_num_binding_page($manifest_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/business/manifest_serial_num_binding_page.html' );
