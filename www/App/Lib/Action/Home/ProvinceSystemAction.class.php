 ...
 *
 */
class ProvinceSystemAction extends ProvinceCommonAction{
	// -------- 系统管理->侧边栏 --------
	public function system_sidebar() {
		layout( './Common/frame' );
		$this->display( './Public/html/Content/Province/system/system_sidebar.html' );
	}
	...
	public function waste_code() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/waste_code.html' );
	...
	public function record_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/waste_code_modify.html' );
	...
	public function district_code() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/district_code.html' );
	...
	public function county_code_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/county_code_modify.html' );
	...
	public function trade_code() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/trade_code.html' );
	...
	public function trade_code_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/trade_code_modify.html' );
	...
	public function enterprise_scale() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/enterprise_scale.html' );
	...
	public function enterprise_scale_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/enterprise_scale_modify.html' );
	...
	public function register_type() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/register_type.html' );
	...
	public function enterprise_register_type_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/enterprise_register_type_modify.html' );
	...
	public function jurisdiction() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/jurisdiction.html' );
	...
	public function jurisdiction_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/jurisdiction_modify.html' );
	...
	public function waste_category() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/waste_category.html' );
	...
	public function waste_category_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/waste_category_modify.html' );
	...
	public function waste_form() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/waste_form.html' );
	...
	public function waste_form_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/waste_form_modify.html' );
	...
	public function package_method() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/package_method.html' );
	...
	public function package_method_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/package_method_modify.html' );
	...
	public function waste_disposal_method() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/waste_disposal_method.html' );
	...
	public function waste_disposal_method_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/waste_disposal_method_modify.html' );
	...
	public function waste_direction() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/waste_direction.html' );
	...
	public function waste_direction_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/waste_direction_modify.html' );
	...
	public function transport_method() {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/transport_method.html' );
	...
	public function transport_method_modify( $record_id="" ) {
		...
		$tmp_content = $this->fetch( './Public/html/Content/Province/system/transport_method_modify.html' );
	...
	// 		$tmp_content=$this->fetch( './Public/html/Content/Province/system/device_add.html' );
	...
	public function device_management() {
		...
		if ( $device ) {
			...
			$tmp_content = $this->fetch( './Public/html/Content/Province/system/device_management.html' );
	...
	public function device_management_detail( $record_id="" ) {
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/system/device_management_detail.html' );
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function device_management_modify( $record_id="" ) {
		...
		if ( $device && $agency && $production_unit && $transport_unit && $reception_unit ) {
			...
			$transport_unit_json = json_encode( $transport_unit );
			$reception_unit_json = json_encode( $reception_unit );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/device_management_modify.html' );
	...
	public function upload_law(){
		...
		// if ( $document ) {
			...
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_law.html' );
	...
	public function upload_law_delete($record_id=""){
		...
		if ( $document ) {
			...
			$document_json = json_encode( $document );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_law_delete.html' );
			$tmp_content = "<script> document_json=$document_json; </script> $tmp_content";
			$this->ajaxReturn( $tmp_content );
		} else {
	...
	public function upload_manual(){
		...
		// if ( $document ) {
			$document_json = json_encode( $document );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_manual.html' );
			$tmp_content = "<script> document_json=$document_json; </script> $tmp_content";
			$this->ajaxReturn( $tmp_content );
		//} else {
			$this->ajaxReturn( '加载页面失败，请重新点击侧边栏加载页面。' );
	...
	public function upload_manual_delete($record_id=""){
		...
		if ( $document ) {
			$this->document = $document;
			$document_json = json_encode( $document );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_manual_delete.html' );
			$tmp_content = "<script> document_json=$document_json; </script> $tmp_content";
			$this->ajaxReturn( $tmp_content );
		} else {
			$this->ajaxReturn( '删除该文档失败，请重新操作。' );
	...
	public function upload_announcement(){
		...
		// if ( $document ) {
			$document_json = json_encode( $document );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_announcement.html' );
			$tmp_content = "<script> document_json=$document_json; </script> $tmp_content";
			$this->ajaxReturn( $tmp_content );
		//} else {
			$this->ajaxReturn( '加载页面失败，请重新点击侧边栏加载页面。' );
	...
	public function upload_announcement_delete($record_id=""){
		...
		if ( $document ) {
			$this->document = $document;
			$document_json = json_encode( $document );
			$tmp_content=$this->fetch( './Public/html/Content/Province/system/upload_announcement_delete.html' );
			$tmp_content = "<script> document_json=$document_json; </script> $tmp_content";
			$this->ajaxReturn( $tmp_content );
		} else {
			$this->ajaxReturn( '删除该文档失败，请重新操作。' );
