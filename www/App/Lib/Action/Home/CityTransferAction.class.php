...
class CityTransferAction extends CityCommonAction{
	...
	public function production_transfer_manifest_page($manifest_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/transfer/production_transfer_manifest_page.html' );
	...
	public function transport_transfer_manifest_page($manifest_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/transfer/transport_transfer_manifest_page.html' );
		// $tmp_content = "<script>manifest_id_json = $manifest_id_json; manifest_status_json = $manifest_status_json; </script> $tmp_content";
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function reception_transfer_manifest_page($manifest_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/City/transfer/reception_transfer_manifest_page.html' );
		// $tmp_content = "<script>manifest_id_json = $manifest_id_json; manifest_status_json = $manifest_status_json; </script> $tmp_content";
		$this->ajaxReturn( $tmp_content );
	}
