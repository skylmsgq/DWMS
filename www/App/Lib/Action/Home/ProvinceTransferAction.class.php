 ...
 *
 */
class ProvinceTransferAction extends ProvinceCommonAction{
	// -------- 危废转移->侧边栏 --------
	public function transfer_sidebar(){
		layout( './Common/frame' );
		$this->display( './Public/html/Content/Province/transfer/transfer_sidebar.html' );
	}
	...
	public function transfer_record(){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_record.html' );
	...
	public function transfer_record_page($record_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_record_page.html' );
		$this->ajaxReturn( $tmp_content );
	}
	...
	public function transfer_manifest(){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_manifest.html' );
	...
	public function transfer_manifest_page($manifest_id=""){
		...
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_manifest_page.html' );
	...
	public function transfer_direction_statistic(){
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_direction_statistic.html' );
		$this->ajaxReturn( $tmp_content );
	}

	// 危废转移->统计分析->转移联单统计
	public function transfer_manifest_statistic(){
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_manifest_statistic.html' );
		$this->ajaxReturn( $tmp_content );
	}

	// 危废转移->统计分析->转移专题定制
	public function transfer_topic_customize(){
		$tmp_content=$this->fetch( './Public/html/Content/Province/transfer/transfer_topic_customize.html' );
		$this->ajaxReturn( $tmp_content );
	}
